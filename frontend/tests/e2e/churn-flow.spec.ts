...
const MOCK_SCRIPT_RESPONSE = {
  script: "[Generated by Llama-3] Thank you for your loyalty. Let me apply a 10% discount to your next bill.",
};
...
test.describe("Enterprise Churn Prediction Flow", () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.routeWebSocket("**/ws/stream", (ws) => {
      ...
      ws.send(
        JSON.stringify({ type: "STATUS_UPDATE", payload: "Engine Online" })
      );
    });
  });
